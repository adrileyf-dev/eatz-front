  ...
  return (
    <div>
      <Card className="bg-app-card border-app-border transition-shadow hover:shadow-md text-white overflow-hidden flex flex-col h-full">
        ...
        {/* 🔥 Ajustado: O contêiner tem altura fixa e relative. Adicionado rounded-t-xl para arredondar só em cima */}
        <div className="relative w-full h-48 bg-muted rounded-t-xl overflow-hidden">
          {product.banner ? (
            <Image
              ...
              alt={product.name}
              fill
              // 🔥 Ajustado: Removidas as classes de dimensionamento (w-full, h-56). Usado object-cover.
        ...
        <CardContent className="p-4 pt-0 flex flex-col flex-1 gap-4">
          ...
          <div className="flex items-center justify-between pt-3 border-t border-app-border mt-auto">
            <div className="flex flex-col">
              ...
              {product.category && (
                <div className="flex items-center gap-1 text-[10px] text-gray-800 mt-1">
